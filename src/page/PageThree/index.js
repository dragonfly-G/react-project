...
class PageThree extends React.Component {
  state = {
    pageThreeList: [
      ...
      {id: 2, name: '拖拽', icon: 'control', page: '/PageThree/DragDrop'},
      {id: 3, name: '左右滑动', icon: 'pic-right', page: '/PageThree/SkideBlock'},
      {id: 4, name: '没有嵌套关系的组件通信', icon: 'trademark', page: '/PageThree/IrrelevantComponent'},
      {id: 5, name: '组件间通信之onRef', icon: 'table', page: '/PageThree/OnRefCommunication'},
      {id: 6, name: '日历组件', icon: 'calendar', page: '/PageThree/Calendar'},
    ]
  }
  render() {
    return (
